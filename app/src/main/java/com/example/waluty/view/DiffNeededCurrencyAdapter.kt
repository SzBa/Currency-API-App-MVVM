...
class DiffNeededCurrencyAdapter(private var currency:List<ConcreteValue>,private var viewModel: FavCurrenciesViewModel):RecyclerView.Adapter<DiffNeededCurrencyAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(parent: MyViewHolder, position: Int) {
        ...
        parent.button.setOnClickListener {
            remove(currency.code,currency.date)
        }
    }
